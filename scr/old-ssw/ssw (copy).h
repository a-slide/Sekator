...
/*! @function       Transform score for match mismatch and ambiguous in a 1D matrix of score
    @param  match   int representing score in case of match
    @param  mismatch   int representing score in case of mismatch
    @param  mismatch   int representing score in case of ambiguous nt
    @return         Matrix of score
*/

int8_t* score_matrix (const int8_t match, const int8_t mismatch, const int8_t ambiguous);
void score_mat_destroy (int8_t* mat);

/*! @function       Transform a DNA sequence in a integer matrix
    @param  seq_len Length of the DNA sequence
    @param  DNA_seq DNA sequence in char
    @return     Integer matrix encoding the sequence
*/

int8_t* DNA_seq_to_int (char* DNA_seq, int seq_len);
void seq_mat_destroy (int8_t* mat);
