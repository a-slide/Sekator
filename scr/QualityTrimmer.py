...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    def __init__(self, qual_cutdown=25, win_size=5, left_trim=True, right_trim=True, min_size=1):
        """
    ...
    def __call__(self, seq):
        ...
        if self.left_trim:
            ...
            for i in np.arange(start=0, stop=seq.qual.size, step=1):
        ...
        if self.right_trim:
            ...
            for i in np.arange(start=seq.qual.size, stop=0, step=-1):
        ...
        if end-start >= self.min_size:
            ...
            return HTSeq.SequenceWithQualities(
